...
### 件名案
> 【アストライダ株式会社様へ】ウェブサイトの課題を無料で診断いたします

> 【Web診断レポート無料進呈】LED投影機・光学部品製造分野でのデジタル競争力強化のご提案
...
貴社の事業内容とLED投影機・光学部品製造分野での実績に大変注目しており、
この度ウェブサイトに関するご提案をさせていただきたく、ご連絡いたしました。

貴社のウェブサイト（https://www.astryda.com/）を拝見したところ、
貴社の高い技術力・信頼性がオンライン上では十分に伝わりにくい状況にあると感じました。

具体的には以下の点が気になりました：
・スマートフォン向け表示最適化が未対応
・英語ページが不在で、海外からのアクセスに対応できない状況
・2025年末〜2026年初に主力製品が多数販売終了しており、製品ポートフォリオの大幅変更期にある
...
貴社サイトは 50点満点中 25点（評価：問題あり）という結果でした。
...
### 件名案
> 【アストライダ株式会社様】Before/Afterモックアップをお送りします
...
【添付モックアップの改善ポイント】
  1. 販売終了製品の整理と代替製品へのリダイレクト設定（高優先度）
  2. サイト内検索機能の実装（ヘッダーに常設）
  3. パンくずリストとアクティブナビゲーション表示の実装
  4. 全URLをhttpsに統一、URL体系を整理
...
アストライダ株式会社様のウェブサイトを拝見し、
2025年末〜2026年初に主力製品が多数販売終了しており、製品ポートフォリオの大幅変更期にあるという点でご提案できることがあると思いまして、
ご連絡させていただきました。
